...
float min_pos[3] = { X_MIN_POS, Y_MIN_POS};
float max_pos[3] = { X_MAX_POS, Y_MAX_POS};
...
// letters for any of the options EXCEPT n.  n must be in lower case because HydraCAM uses a capital
